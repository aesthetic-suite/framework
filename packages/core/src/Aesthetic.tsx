...
> {
  ...
  applyGlobalStyles(baseOptions?: TransformOptions): this {
    ...
    document.documentElement.setAttribute('dir', options.dir);
   ...
   */
  protected getDefaultTransformOptions(
    baseOptions: TransformOptions = {},
  ): Required<TransformOptions> {
    const dir = this.options.rtl ? 'rtl' : 'ltr';

    return {
      dir: typeof baseOptions.dir === 'undefined' ? dir : baseOptions.dir,
      name: '',
      theme: typeof baseOptions.theme === 'undefined' ? this.options.theme : baseOptions.theme,
    };
  }
