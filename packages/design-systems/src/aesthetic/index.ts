...
import { Design, ElementStyles } from '@aesthetic/core';

export default new Design<ElementStyles>('aesthetic', {
  border: {
    sm: {
      radius: '0.14rem', // 2px
  ...
  shadow: {
    ...
    lg: {
      x: '0rem', // 0px
      y: '0.61rem', // 8.47px
      blur: '0.77rem', // 10.72px
      spread: '0rem', // 0px
    },
    xl: {
      x: '0rem', // 0px
      y: '0.98rem', // 13.71px
      blur: '1.34rem', // 18.76px
      spread: '0rem', // 0px
    },
  },
  spacing: {
  ...
  typography: {
    font: {
      ...
      text:
        'Karla, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
      system:
